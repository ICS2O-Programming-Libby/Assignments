...
-- Creating Next Button
    nextButton = widget.newButton( 
        {   
            ...
            defaultFile = "Images/buttonNext.png",
            overFile = "Images/buttonNextPressed.png", 
    ...
    mainMenuButton = widget.newButton( 
        {
            ...
            -- Insert the images here
            defaultFile = "Images/buttonMain.png",  200, 200, 
            overFile = "Images/buttonMainPressed.png",  200, 200,   
...
function scene:create( event )
    ...
    -- Display background
    bkg = display.newImage("PhotoShop/YouLose.png")
